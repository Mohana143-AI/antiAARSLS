  ...
  return (
    <div>
      ...
      <div className="grid-4" style={{ marginBottom: 24 }}>
        {[
          { icon: "👥", label: "Students", val: analytics?.total_students, bg: "var(--accent-bg)", color: "var(--accent)" },
          { icon: "🎓", label: "Faculty", val: analytics?.total_faculty, bg: "var(--info-bg)", color: "var(--info)" },
          { icon: "🔍", label: "Recruiters", val: analytics?.total_recruiters, bg: "var(--success-bg)", color: "var(--success)" },
          { icon: "⭐", label: "Avg Score", val: analytics?.average_reputation?.toFixed(1), bg: "var(--warning-bg)", color: "var(--warning)" },
        ].map(s => (
